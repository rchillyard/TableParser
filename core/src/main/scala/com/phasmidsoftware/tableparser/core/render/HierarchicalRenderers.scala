...
import com.phasmidsoftware.tableparser.core.table.{Header, Indexed}
import com.phasmidsoftware.tableparser.core.util.Reflection
import com.phasmidsoftware.tableparser.core.write
...
trait HierarchicalRenderers {
   ...
   */
  def renderer[T: HierarchicalRenderer](style: String, attrs: Map[String, String] = Map()): HierarchicalRenderer[T] = 
    new TaggedHierarchicalRenderer[T](style, attrs) {}
   ...
   * @return a HierarchicalRenderer[T].
   */
  def rendererExplicit[T: HierarchicalRenderer](style: String, attrs: Map[String, String] = Map())(f: T => String): HierarchicalRenderer[T] = 
    new TaggedHierarchicalRenderer[T](style, attrs) {
  ...
  def headerRenderer(style: String, attrs: Map[String, String] = Map(), sequenced: Boolean)(renderer: HierarchicalRenderer[String]): HierarchicalRenderer[Header] = 
    new TaggedHierarchicalRenderer[Header](style, attrs) {
     ...
     */
    override def render(h: Header, attrs: Map[String, String]): Node = 
      write.Node(style, attrs, headerElements(h).map((t: String) => renderer.render(t)))
   ...
   */
  def sequenceRenderer[T: HierarchicalRenderer](style: String, attrs: Map[String, String] = Map()): HierarchicalRenderer[Seq[T]] = 
    new TaggedHierarchicalRenderer[Seq[T]](style, attrs) {
    override def render(ts: Seq[T], attrs: Map[String, String]): Node = 
      write.Node(style, attrs, ts map (implicitly[HierarchicalRenderer[T]].render(_)))
  }
   ...
   */
  def indexedRenderer[T: HierarchicalRenderer](overallStyle: String, indexStyle: String): HierarchicalRenderer[Indexed[T]] = 
    new HierarchicalRenderer[Indexed[T]] {
    /**
   ...
   */
  def optionRenderer[T: HierarchicalRenderer](style: String, attrs: Map[String, String] = Map()): HierarchicalRenderer[Option[T]] = 
    new TaggedHierarchicalRenderer[Option[T]](style, attrs) {
    override def render(to: Option[T], attrs: Map[String, String]): Node = to match {
      case Some(t) => 
        write.Node(style, attrs, Seq(implicitly[HierarchicalRenderer[T]].render(t)))
      case None => 
        Node("", None, Map(), Nil)
    }
  }
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer2[P1: HierarchicalRenderer, P2: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer3[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer4[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer5[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer6[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
    protected def nodes(t: T): Seq[Node] = {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer7[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer8[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer9[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, P9: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer10[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, P9: HierarchicalRenderer, P10: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer11[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, P9: HierarchicalRenderer, P10: HierarchicalRenderer, P11: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer12[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, P9: HierarchicalRenderer, P10: HierarchicalRenderer, P11: HierarchicalRenderer, P12: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) => T): HierarchicalRenderer[T] = 
    new ProductHierarchicalRenderer[T](style, attrs) {
  ...
  /**
   * Method to return a HierarchicalRenderer[T] where T is a 13-ary Product and which is based on a function to convert a (P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,P11,P12,P13) into a T.
   *
   ...
   * @return a HierarchicalRenderer[T].
   */
  def renderer13[P1: HierarchicalRenderer, P2: HierarchicalRenderer, P3: HierarchicalRenderer, P4: HierarchicalRenderer, P5: HierarchicalRenderer, P6: HierarchicalRenderer, P7: HierarchicalRenderer, P8: HierarchicalRenderer, P9: HierarchicalRenderer, P10: HierarchicalRenderer, P11: HierarchicalRenderer, P12: HierarchicalRenderer, P13: HierarchicalRenderer, T <: Product : ClassTag](style: String, attrs: Map[String, String] = Map())(construct: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) => T): HierarchicalRenderer[T] =
    new ProductHierarchicalRenderer[T](style, attrs) {

      protected def nodes(t: T): Seq[Node] = {
        val Array(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13) = Reflection.extractFieldNames(implicitly[ClassTag[T]])
        Seq(
          implicitly[HierarchicalRenderer[P1]].render(t.productElement(0).asInstanceOf[P1], nameAttr(p1))
          , implicitly[HierarchicalRenderer[P2]].render(t.productElement(1).asInstanceOf[P2], nameAttr(p2))
          , implicitly[HierarchicalRenderer[P3]].render(t.productElement(2).asInstanceOf[P3], nameAttr(p3))
          ...
          , implicitly[HierarchicalRenderer[P11]].render(t.productElement(10).asInstanceOf[P11], nameAttr(p11))
          , implicitly[HierarchicalRenderer[P12]].render(t.productElement(11).asInstanceOf[P12], nameAttr(p12))
          , implicitly[HierarchicalRenderer[P13]].render(t.productElement(12).asInstanceOf[P13], nameAttr(p13))
        )
      }
    }


  private def nameAttr(value: String): Map[String, String] = 
    Map("name" -> value)
}
