...
class TableSpec extends flatspec.AnyFlatSpec with should.Matchers {
  ...
  it should "parse table from file" in {
    import IntPair._
    val z1 = Table.parseFile("core/src/test/resources/com/phasmidsoftware/table/intPairs.csv", "UTF-8")
    val z2 = Table.parseFile("core/src/test/resources/com/phasmidsoftware/table/intPairs.csv")
  ...
  it should "parse table from raw file" in {
    ...
    val z2: IO[Table[RawRow]] = Table.parseFileRaw("core/src/test/resources/com/phasmidsoftware/table/intPairs.csv", TableParser.includeAll)
    matchIO(z1 parProduct z2) {
  ...
  it should "parse from File" in {
    ...
    matchIO(Table.parseFile(new File("core/src/test/resources/com/phasmidsoftware/table/intPairs.csv"))) {
      case xt@HeadedTable(_, _) => xt.size shouldBe 2
    }
  }
