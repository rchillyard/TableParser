...
// CONSIDER how is it that this test runs in around 157 seconds yet the timeout is set to 30 seconds?
  ...
  // TODO fix this test
  private val crimeResource: URL = classOf[Crime].getResource(crimeFile)
